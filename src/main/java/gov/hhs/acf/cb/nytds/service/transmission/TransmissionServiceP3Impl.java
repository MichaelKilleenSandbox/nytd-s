...
import gov.hhs.acf.cb.nytds.persistence.duedate.DueDateDALService;
...
@Service
class TransmissionServiceP3Impl implements TransmissionServiceP3 {
    ...
    private DueDateDALService dueDateDALService;

    public TransmissionServiceP3Impl(MessageDALService messageDALService, TransmissionDALService transmissionDALService, ExtendedDueDateDALService extendedDueDateDALService, TransmissionRecordDALService transmissionRecordDALService, ReportingPeriodDALService reportingPeriodDALService, DueDateDALService dueDateDALService) {
        ...
        this.dueDateDALService = dueDateDALService;
    }
    ...
    private void saveTransmissionDeleteLog(Transmission transmission, SiteUser siteUser) {
        // TODO mjk 9/8/2021 Just a stub until I can move the DB calls out of the actual method.
    }
    ...
    public Calendar getSubmissionDeadline(ReportingPeriod period, Long transmissionTypeId) {
        ...
        Optional<Calendar> endDate = dueDateDALService.findSubmissionDeadline(period,transmissionTypeId);
        Calendar deadline = Calendar.getInstance(TimeZone.getTimeZone("America/New_York"));
        deadline.setTime(endDate.orElseThrow().getTime());
    ...
    @Override
    public Transmission submitTransmission(Transmission transmission, SiteUser stateUser, Boolean ignoreWarning) throws SubmissionException {
        return null;
    }
    ...
    @Override
    public RecordToExport getOutcomesUniverseNotReportedRecord(OutcomesReportSearch search) {
        return null;
    }
