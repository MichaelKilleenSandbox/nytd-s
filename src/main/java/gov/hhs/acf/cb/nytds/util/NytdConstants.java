 ...
 * 
 */
public class NytdConstants
{

	private NytdConstants() {
...
//	public static final String DATA_ERROR_FREE_INFO_SAMPLED = "Contain at least 90 percent error-free information for the elements listed above that contained an unallowable percentage of errors.";
	...
	public static final  Map<String,Integer> e5_sex = ImmutableMap.<String,Integer>builder().put(gov.hhs.acf.cb.nytds.util.NytdConstants.MALE,1).put(gov.hhs.acf.cb.nytds.util.NytdConstants.FEMALE,2).build();
	public static final  Map<String,Integer> element_YES_NO = ImmutableMap.<String,Integer>builder().put(gov.hhs.acf.cb.nytds.util.NytdConstants.YES,1).put(gov.hhs.acf.cb.nytds.util.NytdConstants.NO,0).build();
	public static final  Map<String,Integer> element_YES_NO_UNKNOWN_DECLINED = ImmutableMap.<String,Integer>builder().put(gov.hhs.acf.cb.nytds.util.NytdConstants.YES,1).put(gov.hhs.acf.cb.nytds.util.NytdConstants.NO,0).put(gov.hhs.acf.cb.nytds.util.NytdConstants.DECLINED,2).put(gov.hhs.acf.cb.nytds.util.NytdConstants.UNKNOWN,3).build();
	public static final  Map<String,Integer> element_YES_NO_DECLINED = ImmutableMap.<String,Integer>builder().put(gov.hhs.acf.cb.nytds.util.NytdConstants.YES,1).put(gov.hhs.acf.cb.nytds.util.NytdConstants.NO,0).put(gov.hhs.acf.cb.nytds.util.NytdConstants.DECLINED,2).build();
	public static final  Map<String,Integer> element_YES_NO_NA_DECLINED = ImmutableMap.<String,Integer>builder().put(gov.hhs.acf.cb.nytds.util.NytdConstants.YES,1).put(gov.hhs.acf.cb.nytds.util.NytdConstants.NO,0).put(gov.hhs.acf.cb.nytds.util.NytdConstants.DECLINED,2).put(gov.hhs.acf.cb.nytds.util.NytdConstants.NOT_APPLICABLE,88).build();
	public static final  Map<String,Integer> element_YES_NO_NA_DNK_DECLINED = ImmutableMap.<String,Integer>builder().put(gov.hhs.acf.cb.nytds.util.NytdConstants.YES,1).put(gov.hhs.acf.cb.nytds.util.NytdConstants.NO,0).put(gov.hhs.acf.cb.nytds.util.NytdConstants.DECLINED,2).put(gov.hhs.acf.cb.nytds.util.NytdConstants.DO_NOT_KNOW,3).put(gov.hhs.acf.cb.nytds.util.NytdConstants.NOT_APPLICABLE,88).build();
	public static final  Map<String,Integer> element_YES_NO_DNK_DECLINED = ImmutableMap.<String,Integer>builder().put(gov.hhs.acf.cb.nytds.util.NytdConstants.YES,1).put(gov.hhs.acf.cb.nytds.util.NytdConstants.NO,0).put(gov.hhs.acf.cb.nytds.util.NytdConstants.DECLINED,2).put(gov.hhs.acf.cb.nytds.util.NytdConstants.DO_NOT_KNOW,3).build();
	public static final  Map<String,Integer> e34_Outcomes = ImmutableMap.<String,Integer>builder().put(gov.hhs.acf.cb.nytds.util.NytdConstants.PARTICIPATED,1).put(gov.hhs.acf.cb.nytds.util.NytdConstants.DECLINED,2).put(gov.hhs.acf.cb.nytds.util.NytdConstants.PARENT_DECLINED,3).put(gov.hhs.acf.cb.nytds.util.NytdConstants.INCAPACITATED,4)
			.put(gov.hhs.acf.cb.nytds.util.NytdConstants.INCARCERATED,5).put(gov.hhs.acf.cb.nytds.util.NytdConstants.RUNAWAY_MISSING,6).put(gov.hhs.acf.cb.nytds.util.NytdConstants.UNABLE_TO_LOCATE,7).put(gov.hhs.acf.cb.nytds.util.NytdConstants.DEATH,8).put(gov.hhs.acf.cb.nytds.util.NytdConstants.NOT_IN_SAMPLE,9).build();
	public static final  Map<String,Integer> e46_HigherEdu = ImmutableMap.<String,Integer>builder().put(gov.hhs.acf.cb.nytds.util.NytdConstants.HIGH_SCHOOL_GED,1).put(gov.hhs.acf.cb.nytds.util.NytdConstants.VOCATIONAL_CERTIFICATE,2).put(gov.hhs.acf.cb.nytds.util.NytdConstants.VOCATIONAL_LICENSE,3).put(gov.hhs.acf.cb.nytds.util.NytdConstants.ASSOCIATE,4)
			.put(gov.hhs.acf.cb.nytds.util.NytdConstants.BACHELOR,5).put(gov.hhs.acf.cb.nytds.util.NytdConstants.HIGHER_DEGREE,6).put(gov.hhs.acf.cb.nytds.util.NytdConstants.NONE_OF_THE_ABOVE,7).put(gov.hhs.acf.cb.nytds.util.NytdConstants.DECLINED,8).build();
	public static final  Map<String,Integer> e18_Edu = ImmutableMap.<String,Integer>builder().put(gov.hhs.acf.cb.nytds.util.NytdConstants.UNDER_6,0).put(gov.hhs.acf.cb.nytds.util.NytdConstants.EDU_6,6).put(gov.hhs.acf.cb.nytds.util.NytdConstants.EDU_7,7).put(gov.hhs.acf.cb.nytds.util.NytdConstants.EDU_8,8)
			.put(gov.hhs.acf.cb.nytds.util.NytdConstants.EDU_9,9).put(gov.hhs.acf.cb.nytds.util.NytdConstants.EDU_10,10).put(gov.hhs.acf.cb.nytds.util.NytdConstants.EDU_11,11).put(gov.hhs.acf.cb.nytds.util.NytdConstants.EDU_12,12).put(gov.hhs.acf.cb.nytds.util.NytdConstants.POST_SECONDARY,13).put(gov.hhs.acf.cb.nytds.util.NytdConstants.COLLEGE,14).build();
	
	public static final Map<String,String> string_fields_LABEL = ImmutableMap.<String,String>builder().put(gov.hhs.acf.cb.nytds.util.NytdConstants.FIELD_FILE_NUMBER, gov.hhs.acf.cb.nytds.util.NytdConstants.SPSS_STRING)
			.put(gov.hhs.acf.cb.nytds.util.NytdConstants.FIELD_E2_LABEL, gov.hhs.acf.cb.nytds.util.NytdConstants.SPSS_STRING)
			.put(gov.hhs.acf.cb.nytds.util.NytdConstants.FIELD_E3_LABEL, gov.hhs.acf.cb.nytds.util.NytdConstants.SPSS_STRING)
			.build();
	public static final Map<String,String> string_fields = ImmutableMap.<String,String>builder().put(gov.hhs.acf.cb.nytds.util.NytdConstants.FIELD_FILE_NUMBER, gov.hhs.acf.cb.nytds.util.NytdConstants.SPSS_STRING)
			.put(gov.hhs.acf.cb.nytds.util.NytdConstants.FIELD_E2, gov.hhs.acf.cb.nytds.util.NytdConstants.SPSS_STRING)
			.put(gov.hhs.acf.cb.nytds.util.NytdConstants.FIELD_E3, gov.hhs.acf.cb.nytds.util.NytdConstants.SPSS_STRING)
			.build();
	public static final  Map<String,Integer> e15_FIPS = ImmutableMap.<String,Integer>builder().put(gov.hhs.acf.cb.nytds.util.NytdConstants.CENTRALIZED_UNIT,99999).build();
	public static final  Map<String,String> SPSS_FIELD_NAMES = ImmutableMap.<String,String>builder().put(gov.hhs.acf.cb.nytds.util.NytdConstants.FIELD_FILE_NUMBER,"FILENO").put("E1","STATE").put("E2","REPDATE").put("E3","RECNUMBR").put("E4","DOB").put("E5","SEX").put("E6","AMIAKN").put("E7","ASIAN").put("E8","BLKAFRAM").put("E9","HAWAIIPI").put("E10","WHITE").put("E11","RACEUNKN").put("E12","RACEDCLN").put("E13","HISORGIN").put("E14","FCSTATSV").put("E15","LCLFIPSSV").put("E16","TRIBESV").put("E17","DELINQNTSV").put("E18","EDLEVLSV").put("E19","SPECEDSV").put("E20","ILNASV").put("E21","ACSUPPSV").put("E22","PSEDSUPPSV").put("E23","CAREERSV").put("E24","EMPLYTRSV").put("E25","BUDGETSV").put("E26","HOUSEDSV").put("E27","HLTHEDSV").put("E28","FAMSUPPSV").put("E29","MENTORSV").put("E30","SILSV").put("E31","RMBRDFASV").put("E32","EDUCFINASV").put("E33","OTHRFINASV").put("E34","OUTCMRPT").put("E35","OUTCMDTE").put("E36","OUTCMFCS").put("E37","CURRFTE").put("E38","CURRPTE").put("E39","EMPLYSKLLS").put("E40","SOCSECRTY").put("E41","EDUCAID").put("E42","PUBFINAS").put("E43","PUBFOODAS").put("E44","PUBHOUSAS").put("E45","OTHRFINAS").put("E46","HIGHEDCERT").put("E47","CURRENROLL").put("E48","CNCTADULT").put("E49","HOMELESS").put("E50","SUBABUSE").put("E51","INCARC").put("E52","CHILDREN").put("E53","MARRIAGE").put("E54","MEDICAID").put("E55","OTHRHLTHIN").put("E56","MEDICALIN").put("E57","MENTLHLTHIN").put("E58","PRESCRIPIN")
.build();
}
